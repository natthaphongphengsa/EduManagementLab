...
namespace EduManagementLab.Core.Services
{
    public class CustomProfileService : IProfileService
    {
        ...
        private readonly IMSToolService _toolService;
        ...
        public CustomProfileService(UserService userService, IMSToolService toolService, LinkGenerator linkGenerator, CourseLineItemService courseLineItemService, ResourceLinkService resourceLinkService, CourseService courseService, ILogger<CustomProfileService> logger, IHttpContextAccessor httpContextAccessor)
        {
                    ...
                    case Constants.Lti.LtiResourceLinkRequestMessageType:
                        {
                            ...
                            var courseLineItem = _courseService.GetCourse(member.CourseId, true).CourseLineItems.FirstOrDefault(c => c.ResourceLink.Id == Guid.Parse(id));
        ...
        private List<Claim> GetResourceLinkRequestClaims(ResourceLink resourceLink, CourseLineItem gradebookColumn, User person, Course course)
        {
            ...
            var request = new LtiResourceLinkRequest
            {
                ...
                {
                    ContactEmail = "TEst@example.edu",
                    Description = "Edu plattform",
                    Guid = "localhost:5001",
                    Name = "Edulab Platform",
                    ProductFamilyCode = "Platform",
        ...
        private List<Claim> GetDeepLinkingRequestClaims(IMSTool tool, User person, Course course)
        {
            var httpRequest = _httpContextAccessor.HttpContext.Request;
